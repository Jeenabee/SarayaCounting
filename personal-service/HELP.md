...
* The original package name 'com.saraya.personal-service' is invalid and this project uses 'com.saraya.personalservice' instead.
...
```
$ docker run --rm -p 8080:8080 personal-service:0.0.1-SNAPSHOT
```
