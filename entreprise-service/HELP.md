...
* The original package name 'com.saraya.entreprise-service' is invalid and this project uses 'com.saraya.entrepriseservice' instead.
...
```
$ docker run --rm -p 8080:8080 entreprise-service:0.0.1-SNAPSHOT
```
